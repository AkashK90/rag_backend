  ...
  return (
    <div className="animate-fade" style={{ padding: 28, display: 'flex', flexDirection: 'column', gap: 24 }}>
      <SectionHeader
        ...
        description="Monitor and control the Redis response cache"
        actions={
        ...
        <>
          ...
          <Card>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <InfoRow label="Storage"    value="Redis (persists across server restarts)" />
              ...
              <InfoRow label="Cache Hit"  value="Instant Redis lookup (~5ms)" />
      ...
      <ConfirmModal
        ...
        message={`This will delete all ${stats?.total_cached_keys || 0} cached responses from Redis. Users will experience slightly slower response times until the cache rebuilds. Continue?`}
