...
import { StatCard, Card, Badge, Spinner, StatusDot, SectionHeader } from '../ui/Components'
import { fetchHealth, fetchDocuments, fetchConversations, fetchCacheStats, fetchSessions } from '../../services/api'
    ...
    <div className="animate-fade" style={{ padding: 28, display: 'flex', flexDirection: 'column', gap: 28 }}>
      ...
      <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12 }}>
          ...
          <HealthCard label="Redis"         status={health?.redis}    detail="Cache + Memory" />
        </div>
      </div>
